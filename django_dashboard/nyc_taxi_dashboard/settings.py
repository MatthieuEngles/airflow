...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'nyc_taxi_dashboard' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [BASE_DIR / 'nyc_taxi_dashboard' / 'static']
...
GCP_CREDENTIALS_PATH = os.environ.get('GOOGLE_APPLICATION_CREDENTIALS', '../gcp-credentials.json')
BQ_DATASET_GOLD = os.environ.get('BQ_DATASET_GOLD', 'nyc_taxi_gold')

# MLflow Configuration
MLFLOW_TRACKING_URI = os.environ.get('MLFLOW_TRACKING_URI', 'http://localhost:5555')
